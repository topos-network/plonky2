...
fn test_log_with_aggreg() -> anyhow::Result<()> {
    ...
    let (final_root_proof_first, final_public_values_first) = all_circuits.prove_root(
        &all_stark,
        &config,
        final_inputs_first,
        max_cpu_len,
    ...
    let (final_root_proof_second, final_public_values_second) = all_circuits.prove_root(
        &all_stark,
        &config,
        final_inputs,
        max_cpu_len,
