...
handles initialization (input processing, transaction parsing, tries update...) and termination (receipt creation, final trie checks...) before and after executing the transaction. Subsequent contexts are created when
